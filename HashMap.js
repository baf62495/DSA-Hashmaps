...
class HashMap {
  constructor(initialCapacity = 8) {
    ...
    this._capacity = initialCapacity; // grows in chunks as you resize to a larger array when hash table is full
    this._deleted = 0;
  }
  ...
  set(key, value) {
    ...
    // if the load ratio is greater than max load ratio then resize hash map
